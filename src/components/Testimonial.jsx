        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="w-80 h-80 bg-emerald-600 bg-opacity-20 rounded-full flex items-center justify-center">
                <div className="w-64 h-64 bg-emerald-500 bg-opacity-30 rounded-full flex items-center justify-center">
                  <div className="w-48 h-48 bg-emerald-400 bg-opacity-40 rounded-full flex items-center justify-center">
