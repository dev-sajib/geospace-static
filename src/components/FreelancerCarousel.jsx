...
//
// // Import useEffect and useState if needed
...
//                         }) => {
//     return (
//         <div className={`bg-white rounded-xl border ${isActive ? 'text-emerald-600' : 'border-gray-200'} p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow duration-300 h-full flex flex-col`}>
...
//                         Connect with verified experts in mining, geology, and environmental sciences
//                     </p>
//                 </div>
//
//                 <Swiper
...
//                             <FreelancerCard {...freelancer} isActive={index === activeIndex} />
//                         </SwiperSlide>
//                     ))}
//                 </Swiper>
//             </div>
