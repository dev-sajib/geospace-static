const PressReleaseCard = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
      ...
      {(date || location) && (
        <div className="flex items-center text-emerald-600 font-medium mb-6">
      ...
      {mediaContact && (
        <div className="border-t border-gray-200 pt-6">
          ...
          <div className="text-gray-700">
            <p className="font-semibold">{mediaContact.name}</p>
            <p className="text-gray-600">{mediaContact.title}</p>
            <p className="mt-2 font-semibold">{mediaContact.company}</p>
